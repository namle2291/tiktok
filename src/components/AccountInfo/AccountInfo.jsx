...
import { UserActiveIcon } from '../Icons/Icons';
...
function AccountInfo({ data }) {
    ...
    return (
        <>
            {showModal && <Modal onShow={handleToggleModal} children={<EditProfile onShow={handleToggleModal} />} />}
                ...
                <div className={cx('content')}>
                    <div className={cx('user-info')}>
                        ...
                        <div className={cx('title')}>
                            ...
                            {/* Is Login */}
                            {data.id === user?.id && (
                                <div onClick={handleToggleModal} className={cx('edit-button')}>
                                    <Button
                                        border
                                        children="Sửa hồ sơ"
